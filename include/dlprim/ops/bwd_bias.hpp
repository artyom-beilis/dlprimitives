...
namespace dlprim {
    ...
    public:
        ...
        ~BWBias();
        void backward(Tensor &dy,Tensor &dw,float beta,ExecutionContext const &e)
        {
    ...
    private:
        ...
        void backward_gpu(Tensor &dy,Tensor &dw,float beta,ExecutionContext const &e);
        Context ctx_;
