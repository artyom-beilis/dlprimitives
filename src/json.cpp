...
namespace json {
	...
	bad_value_cast::bad_value_cast() : msg_("dlprim::json::bad_cast") 
	{
	}
	bad_value_cast::bad_value_cast(std::string const &s) : msg_("dlprim::json::bad_cast: "+s ) 
	{
	}
	bad_value_cast::bad_value_cast(std::string const &s,json_type actual) : 
		msg_("dlprim::json::bad_cast: " + s)
	{
	...
	std::string DLPRIM_API to_json(std::string const &s)
	{
